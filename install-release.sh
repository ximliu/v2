...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/ximliu/my-v2ray-core/raw/release/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/ximliu/my-v2ray-core/releases/latest"
