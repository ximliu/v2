...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/alliswell2day/v2/raw/release/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/alliswell2day/v2ray-core/raw/releases"
